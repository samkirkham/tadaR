...
2. Facility to convert TADA files to SSFF format for use with the EMU system: https://github.com/IPS-LMU/emuR This will allow for interactive viewing of gestural synthesis and also take advance of EMU-webApp's gestural annotation algorithms.

3. Plotting functions for generating gestural scores.

4. Forced-alignment of TADA acoustic data to impose segmental boundaries on the gestural score (TADA itself is not segmental, as it synthesises output based on the overlapping gestures)
